...
Routine Load jos continuously stream data into StarRocks using Apache Kafka, or in this lab, Redpanda. The data is streamed into a Kafka topic, and a Routine Load job consumes the data into StarRocks. More details on Routine Load are provided at the end of the lab.
